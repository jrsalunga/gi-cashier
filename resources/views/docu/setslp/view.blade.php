          ...
          <div class="btn-group" role="group">
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/{{brcode()}}/setslp"><span class="fa fa-bank"></span> Card Settlement Slip</a></li>
              </ul>
            </div>
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/{{brcode()}}/setslp/checklist"><span class="fa fa-bank"></span> Card Settlement Slip</a></li>
              </ul>
            </div>
            ...
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/{{brcode()}}/setslp/log"><span class="fa fa-bank"></span> Card Settlement Slip</a></li>
              </ul>
            </div>
