    ...
    $('#filetype').on('change', function(e){
      ...
      if ($(this).val()==='depslp') {
        ...
        alertMessage($('#nav-action'), 'warning', '<b>Tips:</b> <ol><li>Before attaching the scanned Bank Deposit Slip please follow the standard file naming convention.'
          ...
          +'<li>For <b>multiple deposit slip,</b> sample <b>Cash and Check Deposit</b> on <b>one scanned file</b>, kindly sum the <b>Amount (27,052.94)</b> and break it down on <b>Notes</b> sample <b>Cash: 25,000.00, Check: 2,052.94</b></li>'
          +'</ol>'
