    ...
    $('#filetype').on('change', function(e){
      ...
      if ($(this).val()==='depslp') {
        ...
        alertMessage($('#nav-action'), 'warning', '<b>Tips:</b> <ol>'
          +'<li>This facility is intended only to those branches with credit card terminal.</li>'
          ...
          +'<b>20170102</b> - is the Transaction Date in YYYYMMDD format and <b>BDO</b> - is the credit card teminal. '
          +'</li><li> Make sure that the <b>Transaction Date/Time</b> encoded is the <b>Date/Time</b> on the Card Settlement Slip.</li>'
          +'<li>For those branches that have <b>multiple terminal</b>, the file naming should be <b>SETSLP SGD 20180829 BDO</b>, <b>SETSLP SGD 20180829 RCBC</b> or <b>SETSLP SGD 20180829 HSBC</b> and must uploaded separately.'
          +'</li>'
