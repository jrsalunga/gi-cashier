    ...
    $('#filetype').on('change', function(e){
      ...
      if ($(this).val()==='depslp') {
        ...
        alertMessage($('#nav-action'), 'warning', '<b>Tips:</b> <ol>'
          ...
          +'<li>Before attaching the scanned Card Settlement Slip please follow the standard file naming convention.'
          +' Sample "<b>SETSLP SGD 20180829 BDO</b>"</b> where <b>SETSLP</b> - is the document code, <b>SGD</b> - is the 3 char branch code, '
          +'<b>20170102</b> - is the Transaction Date in YYYYMMDD format and <b>BDO</b> - is the credit card teminal.</li>'
          +'<li> Make sure that the <b>Transaction Date/Time</b> encoded is the <b>Date/Time on the Card Settlement Slip</b> and not the current or computer\'s date and time.</li>'
          +'<li>For those branches that have <b>multiple terminal or multiple terminal with the same bank/provider</b>, the file naming should be <b>SETSLP SGD 20180829 BDO</b>, <b>SETSLP SGD 20180829 BDO_2</b>, <b>SETSLP SGD 20180829 RCBC</b> or <b>SETSLP SGD 20180829 HSBC</b> and must uploaded separately.'
          +'</li>'
