    ...
    $('#filetype').on('change', function(e){
      ...
      if ($(this).val()==='depslp') {
        ...
        alertMessage($('#nav-action'), 'warning', '<b>Tips:</b> <ol>'
          ...
          +' Sample "<b>SETSLP SGD 20180901 BDO</b>"</b> where <b>SETSLP</b> - is the document code, <b>SGD</b> - is the 3 char branch code, '
          ...
          +'<li>For those branches that have <b>multiple terminal or multiple terminal with the same bank/provider</b>, the file naming should be <b>SETSLP SGD 20180901 BDO</b>, <b>SETSLP SGD 20180901 BDO_2</b>, <b>SETSLP SGD 20180901 RCBC</b> or <b>SETSLP SGD 20180901 HSBC</b> and must uploaded separately.'
          +'</li>'
